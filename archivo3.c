...
void buscarNombreApellido(FILE *archivo) {
    ...
    if (!encontrado) {
        printf("No se encontro ninguna persona con el nombre y apellido ingresados.\n");
    }
}
